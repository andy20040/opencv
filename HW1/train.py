...
def train_model(model, train_loader, val_loader, epochs, lr, save_name, model_save_path):
    ...
    plt.savefig(f"./HW1/{save_name}.jpg")  # 保存在 HW1/ 下
    plt.close()
    print(f"Training {save_name} finished.")

# ==========================================
# Main Execution - Q1: MNIST LeNet-5
# ==========================================
if __name__ == '__main__':
    # Transform: Resize (28->32), Normalize
    ...
    train_model(model_relu, train_loader, val_loader, epochs=20, lr=0.001, 
                save_name="Loss&Acc_Relu", model_save_path="./HW1/model/Weight_Relu.pth")
    ...
    train_model(model_sigmoid, train_loader, val_loader, epochs=20, lr=0.001, 
                save_name="Loss&Acc_Sigmoid", model_save_path="./HW1/model/Weight_Sigmoid.pth")
    
    print("\n=== Q1 Training Complete! ===")
